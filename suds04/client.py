...
from suds04 import *
from suds04.reader import DefinitionsReader
from suds04.transport import TransportError, Request
from suds04.transport.https import HttpAuthenticated
from suds04.servicedefinition import ServiceDefinition
from suds04 import sudsobject
from sudsobject import Factory as InstFactory
from sudsobject import Object
from suds04.resolver import PathResolver
from suds04.builder import Builder
from suds04.wsdl import Definitions
from suds04.cache import ObjectCache
from suds04.sax.document import Document
from suds04.sax.parser import Parser
from suds04.options import Options
from suds04.properties import Unskin
from urlparse import urlparse
from copy import deepcopy
from suds04.plugin import PluginContainer
...
class Client(object):
    ...
    def items(cls, sobject):
        """
        Extract the I{items} from a suds04 object much like the
        items() method works on I{dict}.
        @param sobject: A suds04 object
    ...
    def metadata(cls, sobject):
        """
        Extract the metadata from a suds04 object.
        @param sobject: A suds04 object
        @type sobject: L{Object}
    ...
    def __unicode__(self):
        s = ['\n']
        build = suds04.__build__.split()
        s.append('Suds ( https://fedorahosted.org/suds04/ )')
        s.append('  version: %s' % suds04.__version__)
...
class SoapClient:
    ...
    def failed(self, binding, error):
        ...
        @param binding: The binding to be used to process the reply.
        @type binding: L{suds04.bindings.binding.Binding}
