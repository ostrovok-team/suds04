...
from suds04 import *
from suds04.sudsobject import *
from suds04.xsd import qualify, isqref
from suds04.xsd.sxbuiltin import Factory
...
class AttrQuery(Query):
    ...
    def __deepsearch(self, schema):
        from suds04.xsd.sxbasic import Attribute
        result = None
        for e in schema.all:
...
class ElementQuery(Query):
    ...
    def __deepsearch(self, schema):
        from suds04.xsd.sxbasic import Element
        result = None
        for e in schema.all:
